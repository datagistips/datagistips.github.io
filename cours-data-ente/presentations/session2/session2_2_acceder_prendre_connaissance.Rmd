...
- `r fa("file", width = "1em")` des indicateurs de développement durable portant sur les déplacements, la qualité de l'air, l'exposition au bruit
...
&#9658; `r fa("file", width = "1em")` Pour ce jeu de données, répondre aux questions suivantes :
