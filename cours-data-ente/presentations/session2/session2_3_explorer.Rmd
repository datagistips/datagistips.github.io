...
[`r fa("file", width = "2em", fill = "rgb(249, 38, 114);")` Cliquez ici pour accéder au dataset](https://trouver.datasud.fr/dataset/epanouissement-de-tous-les-etres-humains-indicateurs-de-developpement-durable)
...
Vous venez de télécharger les données. Faisons quelques petits contrôles :

1. Combien de fichiers trouve-t-on dans le lot de données et sous quel format sont-ils ?

--

2. Combien de fichiers ou jeux de données ont des contenus différents en réalité ? Du coup, y a-t-il des fichiers en doubles (doublons) ?
...
3. Où trouve-t-on la documentation associée aux données ? A savoir le document décrivant l'ensemble des indicateurs, leur origine ?

--

4. Quel fichier comprend l'ensemble des indicateurs/volets listés dans la documentation ?

--

5. Peut-on conduire une étude portant sur l'ensemble des indicateurs de dévéloppement durable sur les Bouches-du-Rhône ?
<!-- dans le fichier Indicateurs DD-2017-Epanouissement des êtres humains.ods -->

--

6. Quel jeu de données comprend des données à l'échelle de l'agglomération ? Y retrouve-t-on plus d'indicateurs que dans l'autre fichier ?
...
1. Dans le fichier *synthese*, les variables apparaissent-elles en colonnes ou en lignes ?
...
3. Pourquoi est-il plus important de mettre cette valeur que de laisser la cellule vide ?
<!-- non déterminé -->
...
Votre cheffe vous pose quelques questions, pour préparer la réunion :
...
Roger, un expert de l'environnement, très pointu sur la qualité de l'air, vous pose quelques questions pièges lors de cette réunion :
