...
# Sur le site data.gouv.fr, on trouve des données ainsi que des (...) ?
...
`r fa("readme", width = "1em")` [Lire l'interview de Mathieu Kazmierski du CRIGE et de Thomas Bekkers de la Région Sud](https://www.cerema.fr/system/files/documents/newsletter/2018/Cerema_Signature66_Def2_1.pdf)
...
![](../images/datactivist.gif)

[Le recensement](https://docs.google.com/spreadsheets/d/1-0qBnEfwBrq8Lfj0WCl4G7V3uL9lVHDDCpsH8VXc1_M/edit#gid=0)

`r fa("readme", width = "1em")` [Lire l'article "Qui a ouvert quoi ?"](https://medium.com/datactivist/qui-a-ouvert-quoi-le-recensement-des-donn%C3%A9es-des-villes-est-maintenant-ouvert-b7f697135c1f)
...
`r fa("readme", width = "1em")` [Lire les réactions sur le forum teamopendata](https://teamopendata.org/t/google-dataset-search/742/4)
